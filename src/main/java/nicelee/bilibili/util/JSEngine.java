...
public class JSEngine {
	...
	public static void main(String[] a) {
		...
		String r = huyaTrans("clientQueryPcdnSchedule1211huyalive"); //f36c9e197149ea1e486c64974580d8d4
	 ...
	 * 初始化huyaJs
	 */
	private static String huyaJs = null;
	private static String initHuyaJs() {
		if(huyaJs == null) {
			StringBuilder sb = new StringBuilder();
			try {
				BufferedReader buReader = new BufferedReader(new InputStreamReader(JSEngine.class.getClassLoader().getResource("huya.js").openStream()));
				String line = null;
				while( (line = buReader.readLine()) != null) {
	...
	public static String huyaTrans(String data) {
        try {
        	//1.得到脚本引擎
